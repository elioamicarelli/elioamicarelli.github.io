...
To visualize this relationship, the figure below plots the deviation of wager distribution from outcomes probabilities against the bookmaker's risk-to-reward ratio. The x-axis shows how much the actual distribution of bets on the favorite deviates from the true underlying probabilities of the outcomes. The y-axis represents the ratio of the most frequent maximum drawdown to the average total profit.
