...
To visualize this relationship, the figure below plots the deviation of wager distribution from outcomes probabilities against the bookmaker's drawdown-to-profit ratio. The x-axis shows how much the actual distribution of bets on the favorite deviates from the true underlying probabilities of the outcomes. The y-axis represents the ratio of the most frequent maximum drawdown to the average total profit.
...
- When the share of wagers shifts heavily toward underdogs (negative values on the x-axis), the drawdown risk increases dramatically. This effect is compounded when the underlying winning probabilities are highly skewed or uneven.

- Conversely, when overbetting occurs on the favorite's side (positive values on the x-axis), the drawdown risk escalates at a much slower, more linear rate.
