...
open-graph:
  title: "Can LLMs replace human survey respondents? The reality of 'Silicon Sampling'"
  description: "I reviewed Verasight's latest research on synthetic respondents. Here is why LLMs aren't ready to replace humans in market research just yet."
  image: ../../figs/silicon_sample_3.png
twitter-card:
  title: "Can LLMs replace human survey respondents?"
  description: "A deep dive into the limitations of Silicon Sampling for social simulation."
  image: ../../figs/silicon_sample_3.png
---
...
*   **Topline Success:** Error on the Generic Ballot (1.8 MAE) and Trump Approval (2.1 MAE) is close to the range of normal sampling noise for a human poll.
...
THESEUS works when Party ID,
ideology, and vote choice are mainly responsible to explain the response variance. But it struggles when the answer depends
on new and still unsettled issues.

Another interesting  finding was that **increasing the sample size did not help.** Increasing the agent pool from 500 to 5,000 had almost no impact on accuracy. This proves that the errors in synthetic polling are **systematic and structural (model bias)**, not statistical noise. You cannot "spend" your way to accuracy by generating more synthetic respondents.
