# The Silicon Sample: A Reality Check on LLM Synthetic Surveys

**Estimated Read Time:** 10 minutes

Can LLMs accurately mimic human survey respondents? Over the past year, the survey research company Verasight published five studies tackling this question from different angles. Part three of my LLMs for Social Simulation series reviews their research to investigate the state of the art in Silicon Sampling. 

My conclusions to date on the topic of Silicon Sampling are the following:
1. Using commercial LLMs with persona-based prompting is not a reliable methodology to obtain accurate survey data.
2. Commercial LLMs are valuable for qualitative applications similar to using traditional user personas in product development, but they are not a valid substitute for empirical measurement.
3. The next phase of LLMs for polling and market research likely resides in specialized, fine-tuned models rather than general-purpose models augmented or steered by prompting.
...
## The Verdict: Why LLMs Aren't Ready for Prime Time
